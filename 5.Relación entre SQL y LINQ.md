...
En una arquitectura de 4 capas, LINQ participa principalmente en la capa de acceso a datos, porque ahí consulta la base de datos.
...
LINQ permite hacer consultas parecidas a SQL, pero dentro del código de C#.
